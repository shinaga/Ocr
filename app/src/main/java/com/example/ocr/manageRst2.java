...
public class manageRst2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_manage_rst2);
        ...
        emailspiner = findViewById(R.id.emailsub2);
        ...
        btn_register3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                || userset.trim().length() == 0 || userset == null){
                    AlertDialog.Builder builder = new AlertDialog.Builder(manageRst2.this);
                    builder.setTitle("알림").setMessage("정보를 바르게 입력하시오").setPositiveButton("확인", null).create().show();
                    AlertDialog alertDialog = builder.create();
                    alertDialog.show();
                }else{

                    Intent intent = new Intent(manageRst2.this, manageRst3.class);
